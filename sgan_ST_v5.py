...
max_vf = np.max(vf_collection)
min_vf = np.min(vf_collection)

vf_collection = (vf_collection - min_vf) / (max_vf - min_vf) - 0.5 #rescale to -0.5 to 0.5
...
G_loss = G_loss + 0.001*cl_loss + 0.01*sl_loss
